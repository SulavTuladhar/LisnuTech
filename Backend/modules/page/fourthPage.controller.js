...
function map_product_request(product,productData){
    if(productData.firstTitle)
        product.firstTitle = productData.firstTitle;
    if(productData.firstDescription)
        product.firstDescription = productData.firstDescription;
    if(productData.secondTitle)
        product.secondTitle = productData.secondTitle;
    if(productData.secondDescription)
        product.secondDescription = productData.secondDescription;
    if(productData.middleDescription)
        product.middleDescription = productData.middleDescription;
    if(productData.img)
